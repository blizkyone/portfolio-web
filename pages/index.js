...
export default function Home() {
  ...
  return (
    <div className="bg-gray-800 text-white">
      ...
      <div className="bg-gray-700 p-14 grid grid-cols-6" ref={dragon}>
        <div className="col-span-6 md:col-span-2">
          ...
          <p
            className="hover:cursor-pointer active:text-gray-200"
            onClick={(_) => menu.current.scrollIntoView({ behavior: "smooth" })}
          >
            back to top
          </p>
        </div>
        <div className="col-span-6 md:col-span-4">
          ...
          <p className="my-2">
            Multiplayer game where you control a simple snake and bet an amount
            of credits, which is your initial carry. If another player crashes
            into you, you absorve his credits up to the amount you currently
            carry. You loose when your whole carry is absorved, and win by
            crashing into yourself as the last snake standing.
          </p>
          ...
          <ul className="my-2 list-disc">
            ...
            <li>
              Authentication using metamask, regardless of blockchain network in
              this demo state.
            </li>
          </ul>
          ...
          <p className="my-2">
            To see the game in action and play against yourself, access the app
            in two different browsers or browser sessions. This has to be done
            for different accounts of metamask to access the game at the same
            time.
          </p>
          <p className="my-2">
            One account creates the room and the other one simply selects the
            room which will automatically appear in the list of available rooms.
          </p>
          <p className="my-2">
            Expect buggy behavior and lag as the backend is hosted in a free
            tier heroku account and I honestly lack the knowledge to monitor
            performance so as to scale efficiently.
          </p>
        </div>
      </div>
      <div className="p-14 grid grid-cols-6" ref={alia}>
        <div className="col-span-6 md:col-span-2">
        ...
        <div className="col-span-6 md:col-span-4">
          <p className="font-bold my-4">Description</p>
          <p className="my-2">
            App to create and list an ERC20 token to represent a share/stake in
            a project of your own.
          </p>
          <p className="my-2">
            You can hand out tokens to any address, create a token sale,
            distribute dividends to token holders and create an automated market
            maker.
          </p>
          <p className="my-2">
          ...
          <p className="my-2">
            All purchases, dividends and AMM will be made against a FUSDC (fake
            USDC) that you can get by pressing the appropriate button in the
            navbar.
          </p>
        </div>
      </div>
      <div className="bg-gray-700 p-14 grid grid-cols-6" ref={land}>
        <div className="col-span-6 md:col-span-2">
        ...
        <div className="col-span-6 md:col-span-4">
          ...
          <p className="my-2">
            ...
            manager account can create new NFTs as the info included in the NFT
            allows you to legally identify the plot of land.
          </p>
          <p className="font-bold my-4">Tech Showcase</p>
          <ul className="my-2 list-disc">
            <li>NodeJS backend with Express API.</li>
            ...
            <li>
              ...
              be able to have multiple smart contracts for the NFT collections.
            </li>
            <li>
          ...
          <p className="my-2">
            ...
            the blockchain transaction when you call it. Reload the page after a
            while to see the changes.
          </p>
        </div>
      </div>
    </div>
